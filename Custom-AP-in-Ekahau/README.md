...
Так же, если Вы берёте готовые файлы из этого репозитария, проверьте, соответствует ли это тому оборудованию, что у Вас в руках. Файлы делают люди и они могут допускать ошибки.
