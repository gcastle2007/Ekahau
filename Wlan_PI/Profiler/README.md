...
- [Что такое Profiler?](#profiler)
- [Не работает Profiler на версии 3.4.2?](#dontwork)
- [Не получается провести профилирование устройств с карточкой Intel BE200?](#be200)
...
Как их обойти? Можно из CLI запустить Profiler в режиме прослушивания трафика на определённом канале. Для этого сначала берём какую либо точку доступа и начинаем на ней вещать какой либо SSID, например,на 36 канале. Далее, запускаем Profiler с консоли на прослушивание 36 канала и с опцией `--noAP`:
```
